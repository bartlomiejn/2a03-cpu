...
std::optional<AddressingMode> CPULogger::addr_mode_for_op(uint8_t opcode) {
    switch (opcode) {
        ...
        case 0x65:
            return {AddressingMode::zp};
        case 0x75:
            return {AddressingMode::zp_x};
        case 0x6D:
            return {AddressingMode::abs};
        case 0x7D:
            return {AddressingMode::abs_x};
        case 0x79:
            return {AddressingMode::abs_y};
        case 0x61:
            return {AddressingMode::idx_ind_x};
        case 0x71:
            return {AddressingMode::ind_idx_y};
        case 0x29:
            return {AddressingMode::imm};
        case 0x25:
            return {AddressingMode::zp};
